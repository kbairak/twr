...
The third will be calculated automatically.
    ...
    parser.add_argument("--price-update-frequency", type=str, help="Price update interval (e.g., '2min', '5min', '1h')")

    # Standard parameters
    parser.add_argument("--num-users", type=int, default=5, help="Number of users (default: 5)")
    parser.add_argument("--num-products", type=int, default=10, help="Number of products (default: 10)")
